...
public class ProductController {
    ...
    @Operation(summary = "Products for the authenticated seller's shop (all statuses)")
    ...
    @Operation(summary = "Update an existing product (SELLER/ADMIN)")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or ((hasAnyRole('SELLER', 'PROVIDER')) and @marketplaceSecurity.isProductOwner(authentication, #id))")
    @Operation(summary = "Delete a product (SELLER/ADMIN)")
    ...
    @PreAuthorize("hasRole('ADMIN') or ((hasAnyRole('SELLER', 'PROVIDER')) and @marketplaceSecurity.isProductOwner(authentication, #id))")
    @Operation(summary = "Add an image to a product (SELLER/ADMIN)")
    ...
    @PreAuthorize("hasRole('ADMIN') or ((hasAnyRole('SELLER', 'PROVIDER')) and @marketplaceSecurity.isProductOwner(authentication, #id))")
    @Operation(summary = "Remove an image from a product by URL (SELLER/ADMIN)")

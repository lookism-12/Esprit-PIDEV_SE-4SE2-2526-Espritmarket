...
public class ShopController {
    ...
    @Operation(summary = "Get the authenticated provider's shop")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or (hasRole('PROVIDER') and @marketplaceSecurity.isShopOwnerByObjectId(authentication, #id))")
